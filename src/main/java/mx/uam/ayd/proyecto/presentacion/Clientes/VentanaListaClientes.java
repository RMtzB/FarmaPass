...
public class VentanaListaClientes extends JFrame {
	...
	/**
	 * muestra : inicializa la ventana VentanaListaClientes
	 * @param controlListaClientes : control correspondiente a esta ventana 
	 */
	...
	/**
	 * agregaClientes : agrega un renglon con la informacion de un cliente
	 * @param e : cliente del cual se añadira la informacion a un renglon
	 */
	public void agregaClientes(Cliente e) {
	...
	/**
	 * getIdSeleccionado : devuelve el id del cliente seleccionado
	 * @return : devuelve el id del cliente seleccionado
	 * @apiNote : se debe verificar primero que se a seleccionado un elemento en la tabla
	 */
