...
public class VentanaRecarga extends JFrame {
	...
	/**
	 * VentanaRecarga: Create the frame.
	 */
					...
					if (textNumero.getText() == "") {
						...
						if ((String) comboBox_1.getSelectedItem() == "...") {
							...
							if (textNumero.getText().length() != 10) {
								...
								controlRecarga.iniciaConfirmacion(Integer.valueOf(textNumero.getText()), compañia,
										Integer.valueOf((String) comboBox_1.getSelectedItem()), usuario);
							}
						}
					}
				} catch (Exception ex) {}
